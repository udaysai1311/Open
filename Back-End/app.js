...
app.use("/customer_registration", verifyToken, customerRoute);
app.use("/materials", verifyToken, materialRoute);
app.use("/machinery-master", verifyToken, machineryRoute);
app.use("/quotations", verifyToken, quotationRoute);
